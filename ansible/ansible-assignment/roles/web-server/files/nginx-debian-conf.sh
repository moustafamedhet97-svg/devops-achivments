echo "========================================"
echo "1. NGINX Web Application Deployment Ubuntu"
echo "========================================"
...
PHANTOM_CONF="/etc/nginx/sites-available/phantom.conf"
EDITORIAL_CONF="/etc/nginx/sites-available/editorial.conf"
HOSTS="/etc/hosts"
...
sudo ln -s $PHANTOM_CONF /etc/nginx/sites-enabled/
...
sudo ln -s $EDITORIAL_CONF /etc/nginx/sites-enabled/
